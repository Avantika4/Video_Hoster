...
import VideoHoster.service.ImageService;
...
public class ImageController {
    ...
    public String createImage(@RequestParam("file") MultipartFile file, @RequestParam("tags") String tags, Image newImage, HttpSession session) throws IOException {
        ...
        byte[] decodedBytes = Base64.getDecoder().decode(uploadedImageData);
        newImage.setImageFile(decodedBytes);
    ...
    public String editImageSubmit(@RequestParam("file") MultipartFile file, @RequestParam("imageId") Integer imageId,@RequestParam("tags") String tags, Image updatedImage, HttpSession session) throws IOException {
        ...
        if (updatedImageData.isEmpty())
            ...
            byte[] decodedBytes = Base64.getDecoder().decode(updatedImageData);
            updatedImage.setImageFile(decodedBytes);
        }
